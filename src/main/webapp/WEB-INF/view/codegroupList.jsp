	...
	<div>
		...
		<nav class="container py-2" id="menu">
			<ul class="nav nav-tabs">
				<li class="nav-item">
					<a class="nav-link active" aria-current="page" href="#" style="color: black;">코드그룹관리</a>					
				</li>
				<li class="nav-item">
					...
					<div class="row px-2 py-2 row-cols-sm-6">
						...
						<div class="col">
							<div class="btn-group me-2 btn-group-sm" role="group" aria-label="First-gropu">
								...
								<button type="button" class="btn btn-outline-secondary" id="" onclick="location.href='./codegroupList.html'">
