...
<body> 
	                            	...
	                            	<c:forEach items="${list }" var="list" varStatus="status">
		                                    ...
		                                    <div class="d-flex bd-highlight">
		                                        ...
		                                        <div class="chat_product_info">
		                                            ...
		                                            <span class="status"><c:out value="${list.ifMmName }"/></span>
					                                 			<p>TEST TEXT FIELD</p>
		                                        </div>
		                                    </div>
		                                </li>
  ...
  //Firebase 프로젝트에서 추출한 정보 입력
	const firebaseConfig = {
  		apiKey: "AIzaSyCU_oVqbYtwdmdGQxsYj4BAK-PI4eLR1S4",
    authDomain: "chat-dddf6.firebaseapp.com",
    databaseURL: "https://chat-dddf6-default-rtdb.firebaseio.com",
    projectId: "chat-dddf6",
    storageBucket: "chat-dddf6.appspot.com",
    messagingSenderId: "402172601879",
    appId: "1:402172601879:web:f83a2a6b62ce6920969e52"
