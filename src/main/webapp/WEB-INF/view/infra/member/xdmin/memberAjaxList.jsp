...
<!-- start -->
	<div>
		...
		<form method="post" name = myForm id="formList">
					...
					<div class="row px-2 py-2 row-cols-sm-6">
						...
						<div class="col">
							<div class="btn-group me-2 btn-group-sm" role="group" aria-label="First-gropu">
								...
								<button type="button" class="btn btn-outline-secondary" id="" onclick="location.href='/member/memberList'">
			...
			<div class="container" style="margin: auto;" id="lita"></div>
...
<!-- end -->
	...
	<!-- DatePicker -->
		...
		var page = $("input:hidden[name=thisPage]").val();
